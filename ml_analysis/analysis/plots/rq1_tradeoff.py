...
plot = sns.relplot(df, x="stability", y="model_quality", hue="Feature Selector", hue_order=get_order(), style="Feature Selector", col="ml_task", col_wrap=2, col_order=['Runtime Kissat', 'Runtime CaDiBack', 'Runtime Spur', 'FM Cardinality', 'Backbone Size', '#SAT Algorithm Selection'], kind="scatter", facet_kws={"legend_out": True}, height=4)
...
plt.figure()
plot = sns.relplot(df, x="rel_count", y="model_quality", hue="Feature Selector", hue_order=get_order(), style="Feature Selector", col="ml_task", col_wrap=2, col_order=['Runtime Kissat', 'Runtime CaDiBack', 'Runtime Spur', 'FM Cardinality', 'Backbone Size', '#SAT Algorithm Selection'], kind="scatter", facet_kws={"legend_out": True}, height=4)
plot.refline(y=0, color="r", linestyle="--")
plot.set_titles(col_template="{col_name}")
