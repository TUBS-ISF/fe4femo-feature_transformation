...
out_path_full = base / "rq1_transformation_quality_by_selector_full.pdf"
out_path_clipped = base / "rq1_transformation_quality_by_selector_clipped.pdf"
...
selector_order = (
    df.groupby("feature_selector")["model_quality"].median().sort_values(ascending=False).index.tolist()
)
