...
VALUE_COL = "preprocessing_seconds"
...
def build_matched_dataset(df: pd.DataFrame) -> pd.DataFrame:
    ...
    # Only compare transformations inside groups where every surviving transformation is present.
...
if __name__ == "__main__":
    ...
    in_path = base / "rq2_preprocessing_dataset.csv"
    matched_path = base / "rq2_preprocessing_matched_dataset.csv"
    summary_path = base / "rq2_preprocessing_matched_summary.csv"
