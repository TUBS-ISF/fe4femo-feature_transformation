        ...
        return List.of(
                ...
                new AnalysisStep() {
                    ...
                    private boolean checkMandatory(IFeatureStructure e) throws InterruptedException {
                        ...
                        else if (e.getParent().isMandatory()) return checkMandatory(e.getParent());
                        else return false;
                    }
                    ...
                    public IntraStepResult analyze(FMInstance fmInstance, int timeout) throws InterruptedException {
                        ...
                        return new IntraStepResult(Map.of(
                                ...
                                getAnalysesNames()[1], String.valueOf(pathMandatoryCount / dyMMerHelper.getFeatureCount(fmInstance)),
                                getAnalysesNames()[2], String.valueOf(pathOptionalCount),
                                getAnalysesNames()[3], String.valueOf(pathOptionalCount / dyMMerHelper.getFeatureCount(fmInstance)),
                                getAnalysesNames()[4], String.valueOf(localMandatoryCount),
                                getAnalysesNames()[5], String.valueOf(localMandatoryCount / dyMMerHelper.getFeatureCount(fmInstance)),
                                getAnalysesNames()[6], String.valueOf(localOptionalCount),
                                getAnalysesNames()[7], String.valueOf(localOptionalCount / dyMMerHelper.getFeatureCount(fmInstance))
                        ), StatusEnum.SUCCESS);
                    }
